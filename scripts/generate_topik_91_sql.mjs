...
const EXAMS = [
  {
    ...
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_i_91.sql'),
  },
  {
    examType: 'TOPIK_II',
    testNumber: 91,
    ...
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_ii_91.sql'),
  },
];
...
async function main() {
  ...
  const manifestPath = path.join(OUTPUT_DIR, 'topik_91_asset_manifest.json');
