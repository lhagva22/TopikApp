...
const EXAMS = [
  {
    ...
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_i', 'topik_i_102.sql'),
  },
  {
    examType: 'TOPIK_II',
    testNumber: 102,
    ...
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_ii', 'topik_ii_102.sql'),
  },
];
...
async function main() {
  ...
  const manifestPath = path.join(OUTPUT_DIR, 'manifests', 'topik_102_asset_manifest.json');
