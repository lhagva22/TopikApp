...
PAPERS_PDF = DOWNLOADS / "60th TOPIK II Test Papers.pdf"
LISTENING_PDF = DOWNLOADS / "60th TOPIK II Listening Text.pdf"
ANSWER_PDF = DOWNLOADS / "60th TOPIK II Answer Sheets.pdf"
LISTENING_AUDIO = DOWNLOADS / "60th-TOPIK-II-Listening-Audio-File-64k-mono.mp3"

OUTPUT_SQL = ROOT / "backend" / "sql" / "seeds" / "mock_tests" / "topik_ii" / "topik_ii_60.sql"
ASSETS_ROOT = ROOT / "topik_ii_60_assets"
UPLOAD_ROOT = ASSETS_ROOT / "upload" / "topik-ii-60"
BACKEND_MEDIA_ROOT = ROOT / "backend" / "public" / "topik-ii-60"

STORAGE_BASE_URL = "https://ywtxdfwntobzegrlyplw.supabase.co/storage/v1/object/public/mock%20test%20files"
AUDIO_URL = f"{STORAGE_BASE_URL}/topik-ii-60/audio/60th-TOPIK-II-Listening-Audio-File-64k-mono.mp3"
MOCK_TEST_ID_SQL = (
    "(SELECT id FROM mock_test_bank "
    "WHERE exam_type = 'TOPIK_II' AND test_number = 60 "
...
READING_PAGE_RANGES = range(5, 26)

LISTENING_IMAGE_URLS: dict[int, str] = {}

LISTENING_OPTION_IMAGE_URLS = {
    1: [f"{STORAGE_BASE_URL}/topik-ii-60/listening/q1_option_{index}.png" for index in range(1, 5)],
    2: [f"{STORAGE_BASE_URL}/topik-ii-60/listening/q2_option_{index}.png" for index in range(1, 5)],
    3: [f"{STORAGE_BASE_URL}/topik-ii-60/listening/q3_option_{index}.png" for index in range(1, 5)],
}

READING_IMAGE_URLS = {
    55: f"{STORAGE_BASE_URL}/topik-ii-60/reading/q55.png",
    56: f"{STORAGE_BASE_URL}/topik-ii-60/reading/q56.png",
    57: f"{STORAGE_BASE_URL}/topik-ii-60/reading/q57.png",
    58: f"{STORAGE_BASE_URL}/topik-ii-60/reading/q58.png",
    59: f"{STORAGE_BASE_URL}/topik-ii-60/reading/q59.png",
    60: f"{STORAGE_BASE_URL}/topik-ii-60/reading/q60.png",
}
...
LISTENING_IMAGE_ASSETS = {
    1: {"page": 1, "block_groups": [[0], [1], [2], [3]]},
    2: {"page": 2, "block_groups": [[0], [1], [2], [3]]},
    3: {"page": 3, "block_groups": [[0], [1], [2], [3]]},
}

READING_IMAGE_ASSETS = {
    55: {"page": 6, "block_indices": [0]},
    56: {"page": 6, "block_indices": [1]},
    57: {"page": 6, "block_indices": [2]},
    58: {"page": 6, "block_indices": [3]},
    59: {"page": 7, "block_indices": [0]},
    60: {"page": 7, "block_indices": [1]},
}
...
def build_sql(questions: list[dict[str, object]]) -> str:
    lines = [
        ...
        ");",
        "",
        f"UPDATE mock_test_bank SET title = 'TOPIK II 60-р шалгалт', description = '60-р албан ёсны TOPIK II шалгалт', total_questions = 100, duration = 130, listening_questions = 50, reading_questions = 50, updated_at = NOW() WHERE id = {MOCK_TEST_ID_SQL};",
        "",
