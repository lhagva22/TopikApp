...
const EXAMS = [
  {
    ...
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_i_64.sql'),
  },
  {
    examType: 'TOPIK_II',
    testNumber: 64,
    ...
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_ii_64.sql'),
  },
];
...
async function main() {
  ...
  const manifestPath = path.join(OUTPUT_DIR, 'topik_64_asset_manifest.json');
