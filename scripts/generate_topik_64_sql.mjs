...
const EXAMS = [
  {
    ...
    readingQuestions: 40,
    folder: 'topik-i-64',
    audioFileName: '64-TOPIK-I-Listening-Audio-File.mp3',
    listeningPageUrl: 'https://www.topikguide.com/mock-tests/64-TOPIK-I-Listening-Mock-Test.html',
    readingPageUrl: 'https://www.topikguide.com/mock-tests/64-TOPIK-I-Reading-Mock-Test.html',
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_i', 'topik_i_64.sql'),
  },
  {
    examType: 'TOPIK_II',
    testNumber: 64,
    ...
    readingQuestions: 50,
    folder: 'topik-ii-64',
    audioFileName: '64-TOPIK-II-Listening-Audio-File.mp3',
    listeningPageUrl: 'https://www.topikguide.com/mock-tests/64-TOPIK-II-Listening-Mock-Test.html',
    readingPageUrl: 'https://www.topikguide.com/mock-tests/64-TOPIK-II-Reading-Mock-Test.html',
    outputSqlPath: path.join(OUTPUT_DIR, 'topik_ii', 'topik_ii_64.sql'),
  },
];
...
function buildSql(exam, rows) {
  ...
  return `-- Generated by scripts/generate_topik_64_sql.mjs
BEGIN;
...
async function main() {
  ...
  const manifestPath = path.join(OUTPUT_DIR, 'manifests', 'topik_64_asset_manifest.json');
