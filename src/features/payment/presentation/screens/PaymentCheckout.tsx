...
const PaymentCheckout = () => {
  ...
  const syncProfile = async () => {
    const response = await paymentUseCases.getProfile();
  ...
  const handleCreateInvoice = async () => {
    ...
    try {
      const response = await paymentUseCases.createQPayPayment(planMonths);
  ...
  const handleCheckPayment = async () => {
    ...
    try {
      const response = await paymentUseCases.checkQPayPayment(payment.id);
  ...
  const handleSimulateSuccess = async () => {
    ...
    try {
      const response = await paymentUseCases.simulateQPayPaymentSuccess(payment.id);
