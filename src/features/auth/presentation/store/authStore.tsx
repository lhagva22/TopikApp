...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  googleLogin: async (idToken: string) => {
    ...
    try {
      const response = await authUseCases.googleLogin({ idToken });
  ...
  register: async (email: string, password: string, name: string) => {
    ...
    try {
      const response = await authUseCases.register({ email, password, name });
  ...
  loadProfile: async () => {
    ...
    try {
      const response = await authUseCases.getProfile();
