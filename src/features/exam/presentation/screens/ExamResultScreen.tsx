...
type ResultRoute = RouteProp<RootDrawerParamList, 'ExamResultScreen'>;
type ResultNavigation = DrawerNavigationProp<RootDrawerParamList, 'ExamResultScreen'>;
          ...
          <View style={styles.correctBar}>
            <View
              style={[
                ...
                { width: `${Math.round((correctAnswers / totalQuestions) * 100)}%` },
              ]}
            />
          </View>
        </View>
                ...
                <View style={styles.sectionBar}>
                  <View
                    style={[
                      ...
                      { width: `${Math.round((listeningScore / listeningMaxScore) * 100)}%` },
              ...
              <View style={styles.sectionBarWrap}>
                <View style={styles.sectionBar}>
                  <View
                    style={[
                      styles.sectionBarFill,
                      { width: `${Math.round((readingScore / readingMaxScore) * 100)}%` },
