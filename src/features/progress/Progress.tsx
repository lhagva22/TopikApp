...
export function Progress() {
  ...
  const getImprovementRate = () => {
    ...
    const recentAvg = recent.reduce((sum, r) => sum + (r.totalScore / r.maxScore) * 100, 0) / recent.length;
    const olderAvg = older.reduce((sum, r) => sum + (r.totalScore / r.maxScore) * 100, 0) / older.length;
  ...
  const getErrorFrequency = () => {
    ...
    filteredResults.forEach(result => {
      result.sections.forEach(section => {
        ...
        if (!errorMap[section.name]) {
          errorMap[section.name] = 0;
        }
        errorMap[section.name] += errors;
      });
    });
      ...
      <View style={styles.container}>
        <View style={styles.centeredContainer}>
          <Card style={styles.paymentCard}>
            ...
            <Text style={styles.paymentTitle}>Ахиц дэвшил</Text>
            <Text style={styles.paymentText}>
              Ахиц дэвшлээ хянахын тулд багц идэвхжүүлэх шаардлагатай
            </Text>
            <Button onPress={() => navigation.goBack()} title="Буцах" />
          </Card>
        </View>
      </View>
    );
        ...
        <View style={styles.contentContainer}>
          ...
          <Card style={styles.emptyCard}>
            ...
            <Text style={styles.emptyText}>
              Та одоогор шалгалт өгөөгүй байна. Эхний шалгалтаа өгч, ахиц дэвшлээ хянах боломжтой.
            </Text>
            <Button onPress={() => navigation.navigate("Mock" as never)} title="Шалгалт өгөх" />
          </Card>
        </View>
      </ScrollView>
    );
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.filterContainer}>
            ...
            >
              <Text style={[styles.filterText, timePeriod === "all" && styles.filterTextActive]}>Бүгд</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.filterButton, timePeriod === "month" && styles.filterButtonActive]}
              onPress={() => setTimePeriod("month")}
            >
              <Text style={[styles.filterText, timePeriod === "month" && styles.filterTextActive]}>Сар</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.filterButton, timePeriod === "week" && styles.filterButtonActive]}
              onPress={() => setTimePeriod("week")}
            >
              <Text style={[styles.filterText, timePeriod === "week" && styles.filterTextActive]}>7 хоног</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.metricsGrid}>
          ...
          <Card style={styles.metricCard}>
            ...
            <Text style={[styles.metricValue, improvementRate >= 0 ? styles.positiveText : styles.negativeText]}>
          ...
          <Card style={styles.metricCard}>
            ...
            <Text style={styles.metricValue}>
              {avgStudyTime}<Text style={styles.metricUnit}>мин</Text>
            </Text>
          </Card>
        </View>
          ...
          <View style={styles.chartHeader}>
            ...
            <View style={styles.viewModeContainer}>
              ...
              >
                ...
                <Text style={[styles.viewModeText, viewMode === "chart" && styles.viewModeTextActive]}>График</Text>
              </TouchableOpacity>
              <TouchableOpacity
              ...
              >
                ...
                <Text style={[styles.viewModeText, viewMode === "list" && styles.viewModeTextActive]}>Жагсаалт</Text>
              </TouchableOpacity>
            </View>
          </View>
                  ...
                  >
                    <View style={styles.listItemLeft}>
                      <View style={[
                        ...
                        percentage >= 80 ? styles.scoreHigh :
                        percentage >= 60 ? styles.scoreMedium :
                        styles.scoreLow
                      ]}>
                    ...
                    <View style={styles.listItemRight}>
                      <View style={styles.listItemScoreDetail}>
                        ...
                        <Text style={styles.listItemScoreValue}>{result.totalScore}/{result.maxScore}</Text>
                      </View>
                ...
                {sectionData.map((item, index) => (
                  <View key={index} style={styles.barChartItem}>
                    ...
                    <View style={styles.barChartBarContainer}>
                      <View style={[styles.barChartBar, { width: `${item.амжилт}%`, backgroundColor: "#3b82f6" }]} />
                    </View>
                    <Text style={styles.barChartValue}>{item.амжилт}%</Text>
                  </View>
                ))}
              </View>
            </Card>
              ...
              <View style={styles.barChartContainer}>
                {errorFrequency.map((item, index) => (
                  <View key={index} style={styles.barChartItem}>
                    ...
                    <View style={styles.barChartBarContainer}>
                      <View style={[styles.barChartBar, { width: `${Math.min(item.count / 10, 100)}%`, backgroundColor: "#ef4444" }]} />
                    </View>
          ...
          <Card style={styles.detailedCard}>
            ...
            <View style={styles.detailedList}>
              {weakAreas.map((area, index) => {
                const errorCount = errorFrequency.find(e => e.category === area.category)?.count || 0;
                return (
                  <View key={index} style={styles.detailedItem}>
                    <View style={styles.detailedItemHeader}>
                      <View style={styles.detailedItemInfo}>
                        ...
                        <View style={[
                          styles.badge,
                          area.accuracy < 60 ? styles.badgeDanger :
                          area.accuracy < 75 ? styles.badgeWarning :
                          styles.badgeSuccess
                        ]}>
                      ...
                      <Text style={[
                        ...
                        area.accuracy < 60 ? styles.percentageDanger :
                        area.accuracy < 75 ? styles.percentageWarning :
                    ...
                    <View style={styles.progressBarContainer}>
                      <View style={[
                        styles.progressBar,
                        area.accuracy < 60 ? styles.progressBarDanger :
                        area.accuracy < 75 ? styles.progressBarWarning :
            ...
            <View style={styles.recommendationContent}>
              ...
              <View style={styles.recommendationText}>
                ...
                <Text style={styles.recommendationDescription}>
                  {weakAreas[0]?.category} хэсэгт {errorFrequency[0]?.count} алдаа гаргасан байна.
                  Энэ хэсгийг сайжруулахын тулд дасгал хийхийг зөвлөж байна.
                </Text>
                <Button onPress={() => navigation.navigate("Practice" as never)} title="Дасгал хийх" />
              </View>
            </View>
          </Card>
