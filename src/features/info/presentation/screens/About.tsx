...
const About = () => {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      {/* Back */}
      <IconButton name="arrow-back" onPress={() => navigation.goBack()} style={styles.backBtn} />
      ...
      <View style={styles.goalCard}>
        <SectionHeader title="Бидний зорилго" style={styles.sectionHeader} />
      ...
      <View style={styles.featuresCard}>
        <SectionHeader title="Юугаараа онцлог вэ?" style={styles.sectionHeader} />
        {FEATURES.map((f) => (
